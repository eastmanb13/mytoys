...
### you can run the line below (commented out now), it will run all the tests in this script
## testthat::test_file(file.path("tests", "testthat", "test-cv.R"))

# Error testing. Could include one expect error for each condition that draws an error.
